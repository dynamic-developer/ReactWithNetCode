...
using ReactWithNetCode.Middlewares;
using Security.Security;
using System;
using System.Threading.Tasks;

namespace ReactWithNetCode
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<MyOwnContext>
                    ...
                    .AddJwtBearer(options =>
                    {
                        options.TokenValidationParameters =
                             new TokenValidationParameters
                             {
                                 ...
                                 ValidIssuer = "MyOwnDemo.Security.Bearer",
                                 ValidAudience = "MyOwnDemo.Security.Bearer",
                                 IssuerSigningKey =
                                  JwtSecurityKey.Create("myowndemo-secret-key")
                             };
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env)
        {
            ...
            app.UseSecureMiddleware();
            app.UseSeccondMiddleware();
